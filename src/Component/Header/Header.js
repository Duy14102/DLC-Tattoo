        ...
        <div className="mainHeader">
            <div className="insideMainHeader">
                ...
                <div className="barsNextToBrand">
                    <NavLink reloadDocument>Trang chủ</NavLink>
                    <NavLink reloadDocument>Blog</NavLink>
                    <NavLink reloadDocument>Dịch vụ</NavLink>
                    <NavLink reloadDocument>Hình Mẫu</NavLink>
                    <NavLink reloadDocument>Booking</NavLink>
