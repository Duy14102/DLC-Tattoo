...
function SignIn({ useReducer, useRef, axios, type, toast, ToastUpdate, cookies }) {
    ...
    return (
        <div className="container__form container--signup">
            <form onSubmit={(e) => submitSignup(e)} className="form" id="form2">
                <h2 className="form__title">Đăng nhập</h2>
                <input value={state.phone} onChange={(e) => setState({ phone: e.target.value })} type="tel" placeholder="Số điện thoại" className="input" required />
