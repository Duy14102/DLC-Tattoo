...
function AccountsTabs({ toast, useRef, axios, ToastUpdate, useEffect }) {
    ...
    return (
        <>
            ...
            />
            <AccountManageModal open={state} setOpen={setState} axios={axios} getAccounts={getAccounts} toast={toast} ToastUpdate={ToastUpdate} id={state.dataModalPass} useRef={useRef} />
        </>
    )
}
