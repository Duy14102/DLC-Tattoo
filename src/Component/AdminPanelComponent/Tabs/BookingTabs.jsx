                                                    ...
                                                    return (
                                                        <Fragment key={u.id}>
                                                            {state?.allSamples.filter(item2 => item2._id === u.id).map((y) => {
                                                                return (
                                                                    <button type="button" id="clickModal" onClick={() => setState({ modalOpen: true, modalData: y, modalData2: u, modalData3: i })} key={y._id} className="samplesImage"><LazyLoadImage alt="Image" src={y.thumbnail} /></button>
                                                                )
                                                            })}
                                                        </Fragment>
                                                    )
                                        ...
                                        <>
                                            ...
                                            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                                                {i.samples.filter(item => item.type === 2).map((u) => {
                                                    return (
                                                        <button type="button" key={u.id} onClick={() => setState({ modalOpen3: true, modalDataX: u, modalData3: i })} className="samplesImage"><LazyLoadImage alt="Image" src={u.image} /></button>
                                                    )
                                                })}
                                            </div>
                                        </>
