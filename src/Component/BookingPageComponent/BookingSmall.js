                        ...
                        <div style={{ marginTop: 10 }}>
                                    ...
                                    return (
                                        <Fragment key={u.id}>
                                            {state?.allSamples?.filter(item2 => item2._id === u.id).map((y) => {
                                                return (
                                                    <div key={y._id} className="samplesImage"><img onClick={() => window.location.href = y.thumbnail} alt="" src={y.thumbnail} />
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 10, marginTop: 5 }}>
                                {state?.haveBooking?.samples?.filter(item => item.type === 2).map((u) => {
                                    return (
                                        <a href={u.image} key={u.id} className="samplesImage"><img alt="" src={u.image} /></a>
                                    )
                                })}
                            </div>
                        </div>
