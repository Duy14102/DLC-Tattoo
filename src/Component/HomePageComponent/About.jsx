    ...
    return (
        <div className="mainAbout">
            <div className="insideMainAbout">
                ...
                <div id="animateRight1" className="animHide coverImgAbout">
                    <LazyLoadImage src={AboutImage} alt="Image" width={"100%"} height={"100%"} />
                </div>
            </div>
                ...
                <div id="animateRight2" className="borderForProcess animHide">
                    <div className="insideBorderForProcess">
                        <div onClick={() => setOptions(1)} className="titleRightUp">
                            <div className="titleDonk"><span>1.</span> Chọn hình và tư vấn miễn phí</div>
                    ...
                    <div className="insideBorderForProcess">
                        <div onClick={() => setOptions(2)} className="titleRightUp">
                            <div className="titleDonk"><span>2.</span> Book lịch xăm tại cửa hàng</div>
                    ...
                    <div className="insideBorderForProcess">
                        <div onClick={() => setOptions(3)} className="titleRightUp">
                            <div className="titleDonk"><span>3.</span> Tận hưởng hình xăm mới</div>
