                    ...
                    {state.haveBooking ? (
                        ...
                        <form onSubmit={(e) => addBooking(e)} className="formBooking">
                            ...
                            <div style={{ display: "flex", alignItems: "center", gap: 20, marginTop: 20 }}>
                                <input value={state.date} placeholder="Ngày" onChange={(e) => setState({ date: e.target.value })} type="date" required />
                                <input value={state.time} placeholder="Giờ" onChange={(e) => setState({ time: e.target.value })} type="time" required />
                            </div>
