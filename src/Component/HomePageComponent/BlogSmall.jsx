                    ...
                    {state.blogs.map((i) => {
                        return (
                            <div key={i._id} className="blogCarousel">
                                <NavLink aria-label={`Read blog ${i.title}`} to={`/ReadBlogPage/${i._id}`} reloadDocument className="blogImg">
                                    <LazyLoadImage src={i.thumbnail} alt="Image" width={"100%"} height={"100%"} />
                                </NavLink>
