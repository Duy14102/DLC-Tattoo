        ...
        <div className="mainTatooSamplePage">
            ...
            {localStorage.getItem("favourites") ? (
                <>
                    ...
                    <TattooSample state={state} setState={setState} params={params} useEffect={useEffect} getSamples={getSamples} useRef={useRef} axios={axios} type={2} currentPage={currentPage} callBackSamples={getSamples}/>
                </>
            ) : (
